...
if service:
    is_correct = is_correct and False
    commentizer("Remember that services let different parts of the app share data? Will this feature be sharing data with any other parts of the app?")
else:
    is_correct = is_correct and True

if not controller:
    is_correct = is_correct and False
    commentizer("This feature will need to know some information about what the deal is. Which component provides data to a template?")
else:
    is_correct = is_correct and True
